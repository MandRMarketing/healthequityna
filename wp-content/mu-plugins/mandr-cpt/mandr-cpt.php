 ...
 *	Locations
 */
add_action('init', 'mandr_create_team_members_cpt');
function mandr_create_team_members_cpt()
{
	...
	$args = array(
		...
		'show_in_admin_bar'   => true,
		'menu_position'       => 5,
		'menu_icon'           => 'dashicons-businessperson', // https://developer.wordpress.org/resource/dashicons/
		//'capability_type'     => 'post', 
		//'capabilities'		  => array( ),
		//'map_meta_cap'		  => null,
		//'hierarchical'		  => false,
