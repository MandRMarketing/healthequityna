		...
		<div class="slick-slider">
			...
			?>
					<div class='slick-slide'>
						...
						?>
							<img data-lazy="<?php echo $sl_image_url; ?>" alt="<?= $img_alt; ?>" />
						<?php
						} else {
						?>
							<picture>
								<!--[if IE 9]><audio><![endif]-->
								<source srcset="<?php echo $sl_image_url_small; ?>" media="(max-width: 480px)">
								<source srcset="<?php echo $sl_image_url_med; ?>" media="(max-width: 768px)">
								<source srcset="<?php echo $sl_image_url; ?>" media="(min-width: 769px)">
								<!--[if IE 9]></audio><![endif]-->
								<img src="<?php echo $sl_image_url_med; ?>" alt="<?= $img_alt; ?>" />
							</picture>
							<?php
						}
