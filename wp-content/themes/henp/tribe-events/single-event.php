...
<div id="tribe-events-content" class="tribe-events-single">
    ...
    <?php while (have_posts()) :  the_post(); ?>
        <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <?php if (tribe_get_address() && tribe_get_city() && tribe_get_state() && tribe_get_zip()) : ?>
                <p><?= tribe_get_address() ?>, <?= tribe_get_city() ?> <?= tribe_get_state() ?>, <?= tribe_get_zip() ?></p>
            <?php endif; ?>
            <!-- <?php
                ...
                <p>
                    <?php foreach ($categories as $category) : ?>
                        <?= $category->name ?><?php if (next($categories)) : ?>, <?php endif; ?>
                <?php endforeach; ?>
                </p>
            <?php endif; ?> -->
    ...
    <section class="section-wrap cards">
        <div class="cards__container Single">
